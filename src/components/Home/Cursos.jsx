      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10">
          {cursos.map((curso) => (
            <div
              key={curso.id}
              className="group relative bg-slate-900/40 backdrop-blur-md border border-slate-800 rounded-2xl overflow-hidden hover:bg-slate-900/60 transition-all duration-300 shadow-2xl flex flex-col"
            >
              {/* Imagen */}
              ...
              <div className="p-5 flex-1 flex flex-col justify-between">
                ...
                <div className="flex items-center justify-between border-t border-slate-800/50 pt-4">
                  <div>
                    <span className="text-2xl font-black text-white tracking-tighter">${curso.precio}</span>
                    <span className="text-[10px] uppercase font-bold text-slate-500 ml-1">{curso.moneda}</span>
                  </div>
